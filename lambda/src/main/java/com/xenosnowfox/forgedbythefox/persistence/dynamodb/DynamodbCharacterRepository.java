...
public class DynamodbCharacterRepository extends AbstractDynamodbRepository<CharacterIdentifier, Character> implements
		CharacterRepository {
	public DynamodbCharacterRepository(
