...
import com.xenosnowfox.forgedbythefox.routes.ShipSheetRoute;
...
import com.xenosnowfox.forgedbythefox.routes.fragment.CharacterCurrencyDisplayFragment;
...
public class ApiGatewayHandler extends Route {
    ...
    public ApiGatewayHandler() {
        ...
        this.register(
                ...
                .register(
                        HttpMethod.ANY,
                        "/fragments/characters/{character}/currency",
                        CharacterCurrencyDisplayFragment.builder()
                                .templateService(templateService)
                                .build())
                .register(
                        HttpMethod.ANY,
